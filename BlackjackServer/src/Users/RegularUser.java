...
public class RegularUser extends User implements IUserAction {
     ...
     * RegularUser if is permission field is 1.
     * This constructor is used when we creating a list of users,
     * containing the user details and his score details.
     * 
     * @param firstName the first name of the RegularUser
     * @param lastName the last name of the RegularUser
     * @param gender the gender of the RegularUser
...
//2 is regular
    ...
    /**
     * This method deletes the RegularUser from the database/list
     *
    ...
    /**
     * This method update the RegularUser in the database/list.
     */
    @Override
    public void update() {
